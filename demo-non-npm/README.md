...
**Currently bundled: client-sdk v3.0.14 / core-sdk v3.0.12.**
...
1. Download the SDK tarball from [releases](https://github.com/exotel/exotel-voip-websdk-sampleapp/releases),
   or use `SDK/exotelsdk-3.0.14.tar.gz` from this repo.
